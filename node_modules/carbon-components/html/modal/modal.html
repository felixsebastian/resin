...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ca24f6byfd">Show
  modal</button>

<div data-modal id="modal-ca24f6byfd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ca24f6byfd-label" aria-describedby="modal-ca24f6byfd-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ca24f6byfd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ca24f6byfd-heading">Modal heading</p>
