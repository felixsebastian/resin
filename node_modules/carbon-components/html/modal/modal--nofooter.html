...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rnuzhuxwc7i">Show
  modal</button>

<div data-modal id="modal-rnuzhuxwc7i" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rnuzhuxwc7i-label" aria-describedby="modal-rnuzhuxwc7i-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rnuzhuxwc7i-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rnuzhuxwc7i-heading">Modal heading</p>
