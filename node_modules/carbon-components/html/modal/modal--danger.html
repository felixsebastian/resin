...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-ntj94k3t64">Show
  modal</button>

<div data-modal id="modal-ntj94k3t64" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-ntj94k3t64-label" aria-describedby="modal-ntj94k3t64-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ntj94k3t64-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ntj94k3t64-heading">Modal heading</p>
